...
(() => {
    ...
    const ITEMS = [
        ...
        { emoji: '🪣', cat: 'bolsa', fact: 'Las bolsas plásticas tardan hasta 20 años en descomponerse.' },
    ...
    const MISSIONS = [
        ...
        { accepts: ['📰', '📦', '📄'], name: 'Recoge solo papel y cartón', icon: '📰', target: 7, prize: 'ballgoal' },
        { accepts: ['🍌', '🍉', '🍎'], name: 'Recoge cáscaras de plátano, de sandía y manzanas mordidas', icon: '🍉', target: 6, prize: 'seesaw' },
        { accepts: ['💩'], name: 'Recoge los residuos peligrosos', icon: '💩', target: 4, prize: 'swing' },
        { accepts: ['🪣'], name: 'Recoge bolsas de plástico', icon: '🪣', target: 7, prize: 'stroller' },
